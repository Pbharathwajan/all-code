...
#defaults: Light mode and Medium Speed
snakecolor = black
bgcolor = white
msgcolor = red
scorecolor = blue
...
veryslow = tk.Button(speed, text = 'Very Slow', command = veryslowbutton, bg = 'blue', fg = 'white')
slow = tk.Button(speed, text = 'Slow', command = slowbutton, bg = 'blue', fg = 'white')
medium = tk.Button(speed, text = 'Medium', command = mediumbutton, bg = 'blue', fg = 'white')
fast = tk.Button(speed, text = 'Fast', command = fastbutton, bg = 'blue', fg = 'white')
veryfast = tk.Button(speed, text = 'Very Fast', command = veryfastbutton, bg = 'blue', fg = 'white')
...
butt = tk.Button(win, text = 'Play',bg = 'red', fg = 'white', command = init)
butt.pack()
